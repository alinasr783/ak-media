      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold">مواعيد اليوم</h3>
          </div>
        </CardHeader>
    ...
    <Card>
      ...
      <CardContent className="space-y-2">
        {appointments.map((appointment) => (
          <div
            key={appointment.id}
            className="flex items-center justify-between p-3 rounded-[var(--radius)] border border-border hover:bg-accent/50 transition-colors"
          >
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                <div className="font-medium">{appointment.patient?.name || "مريض"}</div>
